<div>
                                ...
                                <div class="overflow-x-auto">
                                    <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $donaturList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $donatur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr>
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                        <?php echo e($donaturList->firstItem() + $index); ?>

                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                        <?php echo e($donatur->nama); ?>

                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                        <?php echo e($donatur->email); ?>

                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                        <?php echo e($donatur->telepon); ?>

                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                        <?php echo e($donatur->donasi->count()); ?> donasi
                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                        <a href="<?php echo e(route('donatur.history', $donatur->id)); ?>" class="text-blue-600 hover:text-blue-900 mr-3">Lihat Histori</a>
                                                        <!--[if BLOCK]><![endif]--><?php if($donatur->donasi->count() == 0): ?>
                                                            <button wire:click="confirmDelete(<?php echo e($donatur->id); ?>)" class="text-red-600 hover:text-red-900">Hapus</button>
                                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                    </td>
                                                </tr>
    ...
    <!--[if BLOCK]><![endif]--><?php if($donaturIdToDelete): ?>
...
<?php /**PATH C:\laragon\www\sistem-donasi-online - Copy\resources\views/livewire/donatur/index.blade.php ENDPATH**/ ?>