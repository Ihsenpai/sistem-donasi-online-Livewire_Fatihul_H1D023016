...
$__html = app('livewire')->mount($__name, $__params, 'lw-2452801666-0', $__slots ?? [], get_defined_vars());
...
?>
            ...
            <div class="bg-green-700 text-white py-16">
                <div class="container mx-auto px-4">
                    <div class="max-w-3xl mx-auto text-center">
                        ...
                        <div class="space-x-4">
                            <a href="<?php echo e(route('register')); ?>" class="bg-white text-green-800 hover:bg-green-100 px-6 py-3 rounded-lg font-semibold inline-block">Daftar Sekarang</a>
            ...
            <div class="py-16 bg-gray-50" id="kampanye">
                <div class="container mx-auto px-4">
                    ...
                    <div class="grid md:grid-cols-3 gap-8">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $kampanyeTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kampanye): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                            ...
                            <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-300">
                                <div class="h-48 bg-green-200 flex items-center justify-center">
                                    <div class="text-green-800 font-bold text-xl"><?php echo e($kampanye->kategori->nama_kategori); ?></div>
                                </div>
                                <div class="p-6">
                                    <h3 class="font-bold text-xl mb-2 text-gray-800"><?php echo e($kampanye->nama_kampanye); ?></h3>
                                    <p class="text-gray-600 mb-4"><?php echo e(\Illuminate\Support\Str::limit($kampanye->nama_kampanye, 100)); ?></p>
                                    
                                    <div class="mb-4">
                                        <div class="flex justify-between text-sm mb-1">
                                            <span class="text-gray-600">Terkumpul: Rp<?php echo e(number_format($totalDonasi, 0, ',', '.')); ?></span>
                                            <span class="text-gray-600"><?php echo e($progressPercentage); ?>%</span>
                                        </div>
                                        <div class="w-full bg-gray-200 rounded-full h-2">
                                            <div class="bg-green-600 h-2 rounded-full" style="<?php echo \Illuminate\Support\Arr::toCssStyles(["width" => $progressPercentage."%"]) ?>"></div>
                                        </div>
                                        <div class="text-sm text-gray-500 mt-1">Target: Rp<?php echo e(number_format($kampanye->target, 0, ',', '.')); ?></div>
                                    </div>
                                    
                                    <a href="<?php echo e(route('kampanye.progress', $kampanye->id)); ?>" class="block text-center bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded">Lihat Kampanye</a>
                                </div>
                            </div>
                    ...
                    <div class="text-center mt-10">
                        <a href="<?php echo e(route('kampanye.index')); ?>" class="inline-block bg-green-600 hover:bg-green-700 text-white font-medium py-3 px-6 rounded-lg">Lihat Semua Kampanye</a>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-green-700 text-white py-16">
                <div class="container mx-auto px-4 text-center">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="bg-white text-green-800 hover:bg-green-100 px-8 py-3 rounded-lg font-semibold inline-block">Daftar & Donasi</a>
                </div>
            </div>
            ...
            <footer class="bg-green-800 text-white py-10">
                <div class="container mx-auto px-4 text-center">
                    ...
                    <p class="mt-4 text-green-200">fatihulihsan70@gmail.com</p>
                               ...
                               <?php /**PATH C:\laragon\www\sistem-donasi-online - Copy\resources\views/welcome.blade.php ENDPATH**/ ?>