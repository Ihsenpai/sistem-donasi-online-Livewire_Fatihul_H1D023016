...
<div>
    <h2 class="text-2xl font-bold text-center mb-6 text-green-800">Daftar Akun Baru</h2>
...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="underline text-sm text-green-600 hover:text-green-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500" href="<?php echo e(route('login')); ?>" wire:navigate>
...
</div><?php /**PATH C:\laragon\www\sistem-donasi-online - Copy\resources\views\livewire/pages/auth/register.blade.php ENDPATH**/ ?>