<div>
                    ...
                    <section>
                        ...
                        <div class="mt-6">
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <div>
                                    <a href="<?php echo e(route('kategori.create')); ?>" class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 focus:bg-green-700 active:bg-green-800 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                        Tambah Kategori
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="overflow-x-auto">
                                    <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $kategoriList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr>
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                        <?php echo e($kategoriList->firstItem() + $index); ?>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                        <a href="<?php echo e(route('kategori.edit', $kategori->id)); ?>" class="text-green-600 hover:text-green-900 mr-3">Edit</a>
                                                        <button wire:click="confirmDelete(<?php echo e($kategori->id); ?>)" class="text-red-600 hover:text-red-900">Hapus</button>
                                                    </td>
                                                </tr>
    ...
    <!--[if BLOCK]><![endif]--><?php if($kategoriIdToDelete): ?>
...
<?php /**PATH C:\laragon\www\sistem-donasi-online - Copy\resources\views/livewire/kategori/index.blade.php ENDPATH**/ ?>