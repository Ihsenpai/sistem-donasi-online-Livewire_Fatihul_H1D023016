...
<?php endif; ?>
    ...
    <h2 class="text-2xl font-bold text-center mb-6 text-green-800">Masuk ke Akun Anda</h2>
...
<?php endif; ?>
    ...
    <div class="mt-6">
        ...
        <div class="mt-6 text-center">
            <a href="<?php echo e(route('register')); ?>" class="text-green-600 hover:text-green-800 font-medium">
                Daftar Sekarang
            </a>
        </div>
    </div>
</div><?php /**PATH C:\laragon\www\sistem-donasi-online - Copy\resources\views\livewire/pages/auth/login.blade.php ENDPATH**/ ?>