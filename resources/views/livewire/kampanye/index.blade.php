                    ...
                    <section>
                        ...
                        <div class="mt-6">
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <div>
                                    <a href="{{ route('kampanye.create') }}" class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 focus:bg-green-700 active:bg-green-800 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                        Tambah Kampanye
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="overflow-x-auto">
                                    <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            @forelse ($kampanyeList as $index => $kampanye)
                                                <tr>
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                        {{ $kampanyeList->firstItem() + $index }}
                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                        Rp {{ number_format($kampanye->target, 0, ',', '.') }}
                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                        <a href="{{ route('kampanye.progress', $kampanye->id) }}" class="text-blue-600 hover:text-blue-900 mr-3">Progress</a>
                                                        <a href="{{ route('kampanye.edit', $kampanye->id) }}" class="text-green-600 hover:text-green-900 mr-3">Edit</a>
                                                        <button wire:click="confirmDelete({{ $kampanye->id }})" class="text-red-600 hover:text-red-900">Hapus</button>
                                                    </td>
                                                </tr>
                                            @empty
                                                <tr>
